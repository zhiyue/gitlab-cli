...
pub fn get(project: &str, id: u64) -> RequestSpec {
    RequestSpec::new(
        Method::GET,
        format!("projects/{}/labels/{id}", encode_id(project)),
    )
}
...
pub fn create(project: &str, name: &str, color: &str) -> RequestSpec {
    RequestSpec::new(
        Method::POST,
        format!("projects/{}/labels", encode_id(project)),
    )
...
pub fn subscribe(project: &str, id: u64) -> RequestSpec {
    RequestSpec::new(
        Method::POST,
        format!("projects/{}/labels/{id}/subscribe", encode_id(project)),
    )
}
...
pub fn unsubscribe(project: &str, id: u64) -> RequestSpec {
    RequestSpec::new(
        Method::POST,
        format!("projects/{}/labels/{id}/unsubscribe", encode_id(project)),
    )
}
